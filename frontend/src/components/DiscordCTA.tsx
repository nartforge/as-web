...
const DISCORD_URL = 'https://discord.gg/6N8B4aMJkw'
...
export default function DiscordCTA({ variant = 'inline', title, description, children, style, className }: Props) {
  return (
    <a
      href={DISCORD_URL}
      target="_blank"
      ...
      className={
        (variant === 'hero'
          ? 'btn btn-discord btn-lg pulse-glow'
          : 'btn btn-discord') + (className ? ' ' + className : '')
      }
      style={style}
    >
